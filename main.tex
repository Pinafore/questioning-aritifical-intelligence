...
\documentclass{style/cambridge7A}

%%
% Book metadata
\title{Questioning \\ Artificial \\ Intelligence}
\author{Jordan Boyd-Graber}
\providecommand{\refer}{reference}
\providecommand{\can}{candidate}
...
% They're clones of Bembo and Gill Sans, respctively.
...
\chapterfile{110}{civilization}{Question Answering: The Foundation and
  \\ Savior of Civilization}


\chapterfile{120}{turing}{The Turing Test: The Deceptions that Defined Artificial Intelligence}
...
\chapterfile{240}{leaderboards}{What makes a good AI?  Taking the SAT or being a good tutor?}
