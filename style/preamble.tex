...
\newcommand{\catquestion}[2]{\begin{quote}\colorbox{blue}{\textcolor{white}{\parbox{0.9\linewidth}{\textsc{#1}}}}\\
    \colorbox{blue}{\textcolor{white}{\parbox{0.9\linewidth}{#2}}}\end{quote}}
