...
\newcommand{\iid}{\abr{iid}}  
\newcommand{\feat}[1]{{\small \texttt{#1}}}
\newcommand{\act}[1]{{\small \texttt{#1}}}
\newcommand{\ngram}[0]{$n$-gram}
\newcommand{\watson}{\textit{Watson}}
\newcommand{\answer}[1]{\uline{#1}}
\newcommand{\question}[1]{\begin{center}\colorbox{blue}{\textcolor{white}{\parbox{0.6\linewidth}{{\sffamily
            #1}}}}\end{center}}
\newcommand{\catquestion}[2]{\begin{center}\colorbox{blue}{\textcolor{white}{\parbox{0.6\linewidth}{\centering
         {\sffamily {\bfseries  {\scshape  #1}}}}}}\\
    \colorbox{blue}{\textcolor{white}{\parbox{0.6\linewidth}{{\sffamily #2}}}}\end{center}}
\newcommand{\topic}[1]{\underline{#1}}
\newcommand{\gem}[1]{\mbox{\scshape{gem}}}
\newcommand{\abr}[1]{{\scshape #1}}
\newcommand{\camelabr}[2]{{\small #1}{\scshape{#2}}}
\newcommand{\abrcamel}[2]{{\scshape #1}{\small{#2}}}
\newcommand{\grammar}[1]{{\color{red} #1}}
\newcommand{\explain}[2]{\underbrace{#2}_{\mbox{\footnotesize{#1}}}}
\newcommand{\dir}[1]{\mbox{Dir}(#1)}
\newcommand{\bet}[1]{\mbox{Beta}(#1)}
\newcommand{\py}[1]{\mbox{\scshape{py}}(#1)}
\newcommand{\td}[2]{\mbox{\scshape{TreeDist}}_{#1} \left( #2 \right)}
\newcommand{\yield}[1]{\mbox{\scshape{Yield}} \left( #1 \right)}
\newcommand{\mult}[1]{\mbox{Mult}( #1)}
\newcommand{\wn}{\scshape{WordNet}}
\newcommand{\twentynews}{\scshape{20news}}
\newcommand{\g}{\, | \,}
...
\newcommand{\kl}[2]{D_{\mbox{\scshape{KL}}} \left( #1 \,||\, #2 \right)}
...
\newcommand{\ahintext}[1]{{\small\textcolor{red}{[#1 -- \scshape{hoyle}]}}}
...
\newcommand{\qanta}{\scshape{qanta}}
\newcommand{\muse}{\scshape{muse}}
\newcommand{\squad}{\scshape{sq}{\small u}\scshape{ad}}
\newcommand{\xlnet}{\scshape{x}{\small l}\scshape{n}{\small et}}
\newcommand{\nq}[0]{\abr{nq}}
\newcommand{\conll}{\scshape{c}{\small o}\scshape{nll}}
\newcommand{\hotpot}{\abr{h}{\small otpot}\abr{qa}}
\newcommand{\fever}{\abr{fever}}
\newcommand{\quac}{\scshape{q}{\small u}\scshape{ac}}
\newcommand{\elmo}{\scshape{elm}{\small o}}
\newcommand{\fone}{$F_1$}

% \jeopardyf{} is for end of sentence uses

\newcommand{\category}[1]{\textbf{#1}}
\newcommand{\tfidf}{\abr{tf}-\abr{idf}}



\newcommand{\jeopardy}{\textit{Jeopardy!\@}}
\newcommand{\jeopardyf}{\textit{Jeopardy!}}
\newcommand{\mm}{\abr{llm}}
