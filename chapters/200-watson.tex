...
incorporating computer-like play into their play style~\cite{shin-25}.
%
...
%
What was I doing wasting my time working on language models~\citep{boyd-graber-10:linguistic} if this was
...
%
If you're building a system like
...
%
For example, the constraint is that the correct answer starts with a
particular letter.
%
...
example and generalize that category.
...
reformulations that we saw in QASM:
...
other \abr{qa} settings we’ve looked at is that the category (they text that appears
...
\abr{lsat}~\citep{malik-24} or is better than radiologists in reading X-rays~\citep{bellamy-22}.
%
