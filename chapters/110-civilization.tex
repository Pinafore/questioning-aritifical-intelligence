...
And while there are particular \emph{flavors} of question answering that have been defined to make life easier or more discriminative for computers, the basic task of ``question in'', ``answer out'' is natural to any inquisitive three year old.
%
...
When folks say that a college professor is like a sphinx, they don’t usually mean that in a nice way.  It suggests that we know the answers students need, but we keep them secret for the sake of our own power.  … That’s part of the riddle of [The Sphinx’s] hybrid nature: the curse of being forced to solve a riddle is also the gift of the ability to solve riddles. In Chapter~\ref{ch:manchester}, we will use the Sphinx to help argue why the Manchester Paradigm makes sense as a moniker for probing questions.

\section{The Socratic Method}
\label{sec:civilization:socratic}
...
\section{Only a God Would Ask Questions Like that, ``Gestumblindi''}
\label{sec:civilization:gestumblindi}
...
\jbgcomment{Should add some text about what makes for a good question, perhaps add the FAA stuff here.}
